                            ...
                            <xsl:when
                                ...
                                <xsl:choose>
                                    ...
                                    <xsl:when test="mig2:xsd/mig2:customTypeInfo/mig2:simpleType">
                                        <xs:simpleType>
                                            <xsl:copy-of
                                                select="mig2:xsd/mig2:customTypeInfo/mig2:simpleType/*"
                                                copy-namespaces="no"/>
                                        </xs:simpleType>
                                    </xsl:when>
                                    <xsl:when test="mig2:xsd/mig2:customTypeInfo/mig2:complexType">
                                        <xs:complexType>
                                            <xsl:copy-of
                                                select="mig2:xsd/mig2:customTypeInfo/mig2:complexType/*"
                                                copy-namespaces="no"/>
                                        </xs:complexType>
                                    </xsl:when>
                            ...
                            <xsl:when
                                ...
                                <xsl:choose>
                                    <xsl:when test="mig2:xsd/mig2:typeInfo/mig2:typeAttribute">
                                        <xsl:attribute name="type">
                                            <xsl:value-of
                                                select="mig2:xsd/mig2:typeInfo/mig2:typeAttribute"/>
                                        </xsl:attribute>
                                    </xsl:when>
                                    <xsl:when test="mig2:xsd/mig2:typeInfo/mig2:simpleType">
                                        <xs:simpleType>
                                            <xsl:copy-of
                                                select="mig2:xsd/mig2:typeInfo/mig2:simpleType/*"
                                                copy-namespaces="no"/>
                                        </xs:simpleType>
                                    </xsl:when>
                                    <xsl:when test="mig2:xsd/mig2:typeInfo/mig2:complexType">
                                        <xs:complexType>
                                            <xsl:copy-of
                                                select="mig2:xsd/mig2:typeInfo/mig2:complexType/*"
                                                copy-namespaces="no"/>
                                        </xs:complexType>
                                    </xsl:when>
                                    <xsl:otherwise>*****ERROR*****</xsl:otherwise>
