...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:variable name="currentPartFile">
        <xsl:value-of select="$rightsFile"/>
    </xsl:variable>
        ...
        <html xmlns="http://www.w3.org/1999/xhtml" version="XHTML+RDFa 1.1"
            ...
            <head>
                ...
                <script type="application/ld+json">
                    ...
                    "@type" : "Dataset" ,
                    "@id" : "https://doi.org/10.6069/uwlib.55.A.3.5" ,
                    "creator" : {
                    "@type" : "Organization" ,
                    ...
                    "name" : "RDF Dataset for the Alaska-Yukon-Pacific Exposition Collection, Part V: Rights Statement" ,
                    "alternateName" : "Alaska-Yukon-Pacific Exposition Collection Descriptions, Part V: Rights Statement" ,
                    "description" : "Description of resources that are instances of dct:RightsStatement in the University of Washington Libraries' Alaska-Yukon-Pacific Exposition Collection." ,
                    "publisher" : {
                    "@type" : "Organization" ,
                    "name" : "University of Washington Libraries" ,
                    "url" : "http://www.lib.washington.edu/" ,
