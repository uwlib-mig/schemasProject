...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xs="http://www.w3.org/2001/XMLSchema" xmlns:mig="http://faculty.washington.edu/tgis/xml/xsd" exclude-result-prefixes="xs" version="2.0">
    ...
    <xsl:template match="mig:properties" mode="standalone">
        <table  border="1">
            ...
            <xsl:for-each select="mig:property">
                <tr>
                    <td>
                    ...
                    <td>
                        <xsl:for-each select="mig:description/mig:para">
                            <p><xsl:value-of select="."/></p>
                        </xsl:for-each>
                    </td>
                    <td>
                        <xsl:for-each select="mig:examples/mig:para">
                            <p><xsl:value-of select="."/></p>
                        </xsl:for-each>
                    </td>
                    <td>
